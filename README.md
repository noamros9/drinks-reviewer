...
- Multi-select filter bar on each category page (producer search, type, country with Old/New World groups for wine only, variety with Blend/Single Variety, region)
