...
- Comparison view — select exactly 2 drinks on a category page to compare fields, weighted rating, avg lot price, and tasting history side by side; deep-linkable at `/compare?category=&a=&b=`
