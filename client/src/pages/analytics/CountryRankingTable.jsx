...
export default function CountryRankingTable({ rows, onSelectCountry }) {
  ...
  if (rows.length === 0) return <p className="empty-state">No country data yet.</p>;
  ...
  return (
    <table className="country-ranking-table" data-testid="country-ranking-table">
      <thead>
        <tr>
          {COLUMNS.map(col => (
